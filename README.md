...
This fork is an personal version of the work by ChrisTitusTech. (He has since released a newer design without the leftpanel which I didn't find as useful as the original). 
